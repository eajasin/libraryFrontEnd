...
function App() {
  ...
  const fetchBooks = async () => {
    const response = await fetch("http://ec2-18-222-125-191.us-east-2.compute.amazonaws.com:3000/books")
  ...
  const fetchAuthors = async () => {
    const response = await fetch("http://ec2-18-222-125-191.us-east-2.compute.amazonaws.com:3000/authors")
    const data = await response.json();
    setAuthors(data);
  };
